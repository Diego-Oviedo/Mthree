...
import com.diego.vendingmachine.service.implementation.PaymentServiceImpl.Denominations;

@Component("payment_service_test")
public class PaymentServiceImplStub implements PaymentService {
