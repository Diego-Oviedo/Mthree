...
public class ToDoDatabaseDao implements ToDoDao {
    ...
    public ToDo add(ToDo todo) {
        ...
        /*Lambda that returns a PreparedStatementCreator (parameter for update();)*/
        jdbc.update((Connection conn) -> {//takes the current Connection as a parameter
            ...
            return statement;//returns a completed PreparedStatement.
