...
public class PickyEater {
    ...
    public static void main(String[] args) {
        ...
        String hasSpinach = userInput.nextLine().toLowerCase();

        System.out.print("Is it covered in cheese? (y/n) ");
        String cheeseCovered = userInput.nextLine().toLowerCase();
        ...
        String chocolatedCovered = userInput.nextLine().toLowerCase();

        System.out.print("Does it have a funny name? (y/n) ");
        String funnyName = userInput.nextLine().toLowerCase();

        System.out.print("Is it broccoli? (y/n) ");
        String isBroccoli = userInput.nextLine().toLowerCase();
